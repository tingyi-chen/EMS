# Generated by Django 2.1.10 on 2020-08-28 01:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', models.CharField(blank=True, default='', max_length=4000)),
                ('EnName', models.CharField(default='', max_length=4000, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9-\\*\\(\\)\\u3000\\u3400-\\u4DBF\\u4E00-\\u9FFF ]+$')])),
                ...
                ('LoanReason', models.CharField(default='', max_length=4000)),
                ...
                ('PhotoLink', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', models.CharField(blank=True, default='', max_length=4000)),
                ('EnName', models.CharField(default='', max_length=4000, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9-\\*\\(\\)\\u3000\\u3400-\\u4DBF\\u4E00-\\u9FFF ]+$')])),
                ('SerialNumber', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9- ]+$')])),
                ...
                ('ChDescription', models.CharField(blank=True, default='', max_length=4000)),
                ('EnDescription', models.CharField(blank=True, default='', max_length=4000)),
                ('LimitFreezeQnty', models.IntegerField(default=1, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('Specification', models.CharField(blank=True, default='', max_length=4000)),
                ('Limitations', models.CharField(blank=True, default='', max_length=4000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('OtherDemand', models.CharField(blank=True, default='', max_length=4000, null=True)),
                ('Deleted', models.BooleanField(default=False)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EquipmentNo', models.CharField(default='', max_length=255)),
                ('ToolingNo', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9- ]+$')])),
                ('Name', models.CharField(blank=True, default='', max_length=4000)),
                ('EnName', models.CharField(default='', max_length=4000, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9-\\*\\(\\)\\u3000\\u3400-\\u4DBF\\u4E00-\\u9FFF ]+$')])),
                ...
                ('Comment', models.CharField(blank=True, default='', max_length=4000, null=True)),
