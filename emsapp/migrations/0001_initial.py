# Generated by Django 2.1.10 on 2020-08-07 07:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Date', models.DateField(blank=True, default='2020-08-07', null=True)),
                ('Time', models.TimeField(blank=True, default='15:21:53', null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LoanStartTime', models.DateField(default='2020-08-07')),
                ('LoanEndTime', models.DateField(default='2021-02-07')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ToolingNo', models.CharField(blank=True, default='', max_length=255, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ...
                ('EnName', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z ]+$')])),
                ('SerialNumber', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('EquipmentOwnerID', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('EquipmentOwnerName', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z ]+$')])),
                ...
                ('CreateDate', models.DateField(default='2020-08-07')),
                ...
                ('NonStockNo', models.CharField(blank=True, default='', max_length=255, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('LastNonStockShipDate', models.DateField(blank=True, default='2020-08-07')),
                ('NonStockSpace', models.FloatField(blank=True, default=0, null=True)),
                ('LastModifyDate', models.DateField(default='2020-08-07')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NonStockNo', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[0-9]+$')])),
                ('EquipmentNo', models.CharField(default='', max_length=255)),
                ('TicketCreateTime', models.DateField(default='2020-08-07')),
                ('TicketCreateUser', models.CharField(default='', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9]+$')])),
                ('TransactionReqTime', models.DateField(default='2020-08-07')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ProdVendor', models.CharField(default='', max_length=255)),
                ('PhotoLink', models.CharField(default='', max_length=255)),
                ('CalibratedTicketCreateDate', models.DateField(default='2020-08-07')),
                ('CalibratedStartTime', models.DateField(default='2020-08-07')),
                ...
                ('CalibratedEndTime', models.DateField(default='2020-08-21')),
