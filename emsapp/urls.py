...
urlpatterns = [
    ...
    url(r'^trashbin/equipment/$', views.TrashBinView.equipment, name='trashBinOthers'),
    ...
    url(r'^assetloanrecord/(?P<eqpk>[0-9]+)/form/$', views.AssetLoanRecordFormView.as_view(), name='assetLoanForm'),
